...
AS $$
BEGIN
  -- Atualiza planos pendentes para histu00f3rico quando existe um plano ativo para o mesmo usuu00e1rio
  ...
  RAISE NOTICE 'Planos pendentes atualizados para histu00f3rico quando o usuu00e1rio ju00e1 possui um plano ativo';
END;
$$;
...
AS $$
BEGIN
  -- Se um plano se tornou ativo, atualiza outros planos pendentes para histu00f3rico
